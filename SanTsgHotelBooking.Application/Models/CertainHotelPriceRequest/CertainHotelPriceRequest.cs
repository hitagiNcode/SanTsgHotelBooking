namespace SanTsgHotelBooking.Application.Models.CertainHotelPriceRequest
{
    public class CertainHotelPriceRequest
    {
        ...
        public List<RoomCriterion> roomCriteria { get; set; } = new List<RoomCriterion> { new RoomCriterion { adult = 1 } };
